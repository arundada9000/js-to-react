    ...
    if (lofiToggle && lofiPlayer) {
        lofiToggle.addEventListener('click', () => {
            ...
            if (!isIframeInjected) {
                ...
                document.getElementById("yt-iframe").style.display = "block"; icon.classList.remove("fa-headphones");
                ...
                if (iframe && iframe.contentWindow) {
                    if (isLofiPlaying) {
                        ...
                        document.getElementById("yt-iframe").style.display = "none"; icon.classList.remove("fa-circle-pause");
