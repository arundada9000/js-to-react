const curriculum = [
  // ─── PHASE 1: JavaScript Foundations ───
  {
    ...
    exercises: [
      {
        question: `Pooja just moved to a new city! Create three variables: name (const), age (let), and city (const) with values "Pooja", 22, and "Butwal". Print them using a template literal: "Pooja is 22 years old and lives in Butwal."`,
        hint: "Use const for values that won't change, let for values that might. Template literals use backticks and ${} for variables.",
        solutionCode: `const name = "Pooja";
let age = 22;
const city = "Butwal";

console.log(\`\${name} is \${age} years old and lives in \${city}.\`);`,
        expectedResult: "Pooja is 22 years old and lives in Butwal.",
      },
      {
...
console.log(orderFood("momo"));`,
      ...
      {
        question: `Write a function gradeExam(score) that returns:\n- "A" for 90-100\n- "B" for 80-89\n- "C" for 70-79\n- "D" for 60-69\n- "Fail" for below 60\nSuRu (Pooja) scored 85 on her JavaScript quiz. What grade does she get?`,
...
console.log(\`Total: Rs. \${calcTotal3(4, 180)}\`);`,
      ...
      {
        question: `Create an arrow function greetUser that takes a name and a greeting with a default parameter greeting = "Namaste". If no greeting is provided, it should use "Namaste". Call it twice: once with just "Pooja", and once with "Arun" and "Hey".`,
...
console.log(greetUser("Arun", "Hey"));`,
        expectedResult: `Namaste, Pooja!
Hey, Arun!`,
      },
      {
        question: `Write a function createBill that takes a customer name and an array of item prices. It should return an object with: customer, itemCount, subtotal, vat (13%), and total. Call it with "Pooja" and [200, 80, 150].`,
...
const bill = createBill("Pooja", [200, 80, 150]);
console.log(bill);`,
...
city and food are not accessible outside their functions`,
  ...
  // ─── PHASE 4: Arrays ───
  {
    ...
    exercises: [
      {
        question: `Create an array of Pooja's favorite Nepali foods: "momo", "dal bhat", "chatpate", "sel roti". Then:\n1. Add "thukpa" to the end\n2. Remove the first item\n3. Print the array length and the updated array.`,
...
Lumbini found: true, at index: 2`,
      ...
      {
        question: `Use splice to modify an array in place. Start with Pooja's schedule: ["Wake up", "Breakfast", "Netflix", "Lunch", "Netflix", "Dinner"]. Replace both "Netflix" entries with "Study JavaScript" and "Practice coding" using splice. Print the result.`,
...
Total items: 6`,
  ...
  // ─── PHASE 5: Objects ───
  {
    ...
    exercises: [
      {
        question: `Create a "restaurant" object with: name ("Pooja's Kitchen"), location ("Butwal"), rating (4.8), and isOpen (true). Access the name using dot notation and the rating using bracket notation. Print both.`,
...
console.log(restaurant["rating"]);`,
        expectedResult: `Pooja's Kitchen
4.8`,
      },
      {
...
selRoti: Rs. 30`,
  ...
  // ─── PHASE 6: Modern ES6+ ───
  {
    ...
    exercises: [
      {
        question: `Pooja's profile object has: name, age, city, hobby. Use object destructuring to extract name and city into variables in one line. Also rename 'hobby' to 'favoriteHobby' during destructuring. Print all three.`,
        hint: "Destructuring with rename: const { oldName: newName } = obj. This creates a variable called newName.",
        solutionCode: `const Pooja = {
  name: "Pooja",
  age: 22,
  city: "Butwal",
  hobby: "coding"
...
const { name, city, hobby: favoriteHobby } = Pooja;

console.log(name);
console.log(city);
console.log(favoriteHobby);`,
        expectedResult: `Pooja
Butwal
coding`,
      },
      {
...
Card: No card on file`,
  ...
  // ─── PHASE 7: Array Methods (React Essentials) ───
  {
    ...
    exercises: [
      {
        question: `You have an array of friends: ["Arun", "Pooja", "Ram", "Sita"]. Use .map() to create a new array where each name becomes an object with id and name properties. The id should be the index + 1. Print the result.`,
        hint: "map((item, index) => ...) gives you both the element and its index. Return a new object for each element.",
        solutionCode: `const friends = ["Arun", "Pooja", "Ram", "Sita"];
...
console.log(friendObjects);`,
        expectedResult: `[{id: 1, name: "Arun"}, {id: 2, name: "Pooja"}, {id: 3, name: "Ram"}, {id: 4, name: "Sita"}]`,
      },
      {
...
All above Rs. 20: true`,
      ...
      {
        question: `Pooja is tracking expenses for a trip to Pokhara. Given an array of expenses [{item, amount}], use reduce() to calculate the total. Then find the most expensive item.`,
...
Most expensive: Hotel (Rs. 2500)`,
  ...
  { name: "Pooja", score: 92, subject: "JS" },
...
console.log("Top students:", topStudents);`,
        expectedResult: `Top students: ["Arun", "Sita", "Pooja"]`,
      },
    ],
  },
  ...
  // ─── PHASE 8: Asynchronous JavaScript ───
  {
    ...
    exercises: [
      {
        question: `Create a Promise called fetchOrder that simulates fetching Pooja's food order. After 1 second, it should resolve with {item: "momo", quantity: 2, status: "ready"}. Handle it with .then() and .catch().`,
...
chatpate: Rs. 50`,
  ...
  // ─── PHASE 9: DOM Manipulation ───
  {
    ...
    exercises: [
      {
        question: `Write code that selects an element with id="greeting", changes its text to "Namaste, Pooja!", adds a CSS class "highlight" to it, and changes its color to blue. (Imagine the HTML element exists.)`,
...
let contacts = [];
contacts = addContact(contacts, "Pooja", "9801234567");
...
console.log("After delete:", contacts.map(c => c.name));`,
        expectedResult: `Search 'su': ["Pooja", "Sunil KC"]
After delete: ["Pooja", "Arun", "Sunil KC"]`,
      },
      {
        question: `Build a simple expense tracker using closures and higher-order functions. Create a makeExpenseTracker(budget) function that returns an object with: addExpense(desc, amount), getBalance(), and getSummary(). Track expenses for a trip to Pokhara with Pooja with budget Rs. 5000.`,
...
{budget: 5000, spent: 3200, balance: 1800, items: 3}`,
  ...
  { id: 1, customer: "Pooja", city: "Butwal", items: ["momo", "tea"], total: 280 },
...
console.log(\`Grand total: Rs. \${grandTotal}\`);`,
        expectedResult: `Butwal orders: [{customer: "Arun", itemCount: 3, total: 350}, {customer: "Pooja", itemCount: 2, total: 280}, {customer: "Hari", itemCount: 1, total: 60}]
Grand total: Rs. 690`,
      },
    ],
  },
